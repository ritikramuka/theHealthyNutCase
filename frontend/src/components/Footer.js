        ...
        <div className="FooterLinksContainer">
          <div className="FooterLinksWrapper">
            <div className="FooterLinkItems">
              <div className="FooterLinkTitle">The really important stuff</div>
              <Link className="FooterLink" to='/return-refund'>Return, Refund and Cancellation Policy</Link>
              <Link className="FooterLink" to='/get-in-touch'>Get in touch</Link>
              <Link className="FooterLink" to='/terms-conditions'>Terms and conditions</Link>
          ...
          <div className="FooterLinksWrapper">
            <div className="FooterLinkItems">
              ...
              <div className="FooterLink">
                Call/email us on the details mentioned below and we’ll be happy answer all your questions!
              </div>
              <div className="FooterLink">
                <div>
                  Customer Service: 8800610474
                </div>
                <div>
                  Email: <a className='email' href="mailto:healthynutcase01@gmail.com">healthynutcase01@gmail.com</a>
                </div>
                <div>
                  Monday to Friday (10.30 am - 7 pm)
                </div>
                <br/>
                <a
                  className="Instagram"
                  href="https://www.instagram.com/thehealthynutcase/?utm_medium=copy_link"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  className="Facebook"
                  href="https://www.facebook.com/thehealthynutcase/"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="facebook"
                >
